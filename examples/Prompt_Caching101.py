...
client = OpenAI(organization="org-M17jiHIEeumLmDCKfu76X9sI", api_key=api_key)
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "reason": {"type": "string", "description": "The reason for cancelling the order."},
                },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "order_id": {"type": "string", "description": "The customer's order ID."},
                    "item_id": {"type": "string", "description": "The specific item ID the customer wants to return."},
                    "reason": {"type": "string", "description": "The reason for returning the item."},
                },
...
def completion_run(messages, tools):
    completion = client.chat.completions.create(
        model="gpt-4o-mini", tools=tools, messages=messages, tool_choice="required"
    )
...
def main(sauce_url, veggie_url):
    multiimage_completion(sauce_url, veggie_url, "Please list the types of sauces that are shown in these images")
    # delay for 20 seconds
    time.sleep(20)
    multiimage_completion(sauce_url, veggie_url, "Please list the types of vegetables that are shown in these images")
    time.sleep(20)
    multiimage_completion(milk_url, sauce_url, "Please list the types of sauces that are shown in these images")
