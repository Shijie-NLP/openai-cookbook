...
transcribe(
    up_first_filepath,
    prompt="""Hi there and welcome to the show.
###
...
# ## Pass names in the prompt to prevent misspelling
#
...
transcribe(
    product_names_filepath,
    prompt="QuirkQuid Quill Inc, P3-Quattro, O3-Omni, B3-BondX, E3-Equity, W3-WrapZ, O2-Outlier, U3-UniFund, M3-Mover",
)


# Now, let's switch to another audio recording authored specifically for this demonstration, on the topic of an odd barbecue.
#
